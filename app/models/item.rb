class Item < ApplicationRecord
  ...
  validates :price,           presence: true, format: { with: /\A([1-9]\d*,)*[1-9]\d*\z/, message: 'is invalid. Input half-width characters' },numericality: { only_integer: true, greater_than_or_equal_to: 300, less_than_or_equal_to: 9999999, message: 'is out of setting range' }                                              
