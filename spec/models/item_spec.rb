RSpec.describe Item, type: :model do
  ...
  context '新規登録できるとき' do
    ...
    it 'item_name、item_detail、price、categoly_id、item_state_id、delivery_fee_id、prefecture_id、spend_day_idを入力すれば登録ができる' do
  ...
  context '新規登録できないとき' do
    ...
    it 'spend_day_idが選択されていないと登録できない' do
      @item.spend_day_id = '0'
      @item.valid?
      expect(@item.errors.full_messages).to include("Scheduled delively can't be blank")
    end
